...
<head>
    ...
    <script>
        ...
        window.DatLichTienIchRoutes = {
            show: {!! \Illuminate\Support\Js::from(route('manager.dat-lich-tien-ich.show', ['datLichTienIch' => '__ID__'])) !!},
        };
    </script>
            ...
            @php
                $navGroups = [
                    ...
                    'QUẢN LÝ CHUNG CƯ' => [
                        ...
                        ['route' => 'manager.cu-dan-can-ho.index', 'label' => 'Cư dân - Căn hộ', 'icon' => 'residency', 'active' => 'manager.cu-dan-can-ho.*'],
                ...
                $icons = [
                    ...
                    'residency'  => 'M3 7h18M5 7v12a2 2 0 002 2h10a2 2 0 002-2V7M9 11h6M9 15h4',

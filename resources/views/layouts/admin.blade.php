...
<div class="flex h-screen overflow-hidden">
   ...
   class="sidebar-link {{ request()->routeIs('admin.cu-dan-can-ho.*') ? 'active' : 'text-slate-300' }}">
    ...
    <span x-show="sidebarOpen" class="truncate">Cư dân - Căn hộ</span>
            ...
            <a href="{{ route('admin.yeu-cau.index') }}" class="sidebar-link {{ request()->routeIs('admin.yeu-cau.*') ? 'active' : 'text-slate-300' }}">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                <span x-show="sidebarOpen" class="truncate">Yêu cầu cư dân</span>
            </a>
            <div x-show="sidebarOpen" class="pt-3 pb-1">
            ...
            <a href="{{ route('admin.phi-dich-vu.index') }}" class="sidebar-link {{ request()->routeIs('admin.phi-dich-vu.*') ? 'active' : 'text-slate-300' }}">

...
<div class="max-w-2xl">
    ...
    <form method="POST" action="{{ route('admin.can-ho.update', $canHo) }}"
        ...
        <div class="p-6 space-y-5">
            ...
            <div>
                ...
                <select name="toa_nha" required
                    ...
                    <option value="{{ $tn->id }}" @selected(old('toa_nha', $canHo->toa_nha) == $tn->id)>
                        {{ $tn->ten_toa_nha }}
                    </option>
                    @endforeach
                </select>
            ...
            <div>
                ...
                <select name="loai_can_ho" required
                    ...
                    <option value="{{ $loai->id }}" @selected(old('loai_can_ho', $canHo->loai_can_ho) == $loai->id)>
            ...
            <div>
                ...
                <select name="trang_thai" required
                    ...
                    <option value="{{ $tt->id }}" @selected(old('trang_thai', $canHo->trang_thai) == $tt->id)>
                        {{ $tt->ten_trang_thai }}
                    </option>
                    @endforeach
                </select>

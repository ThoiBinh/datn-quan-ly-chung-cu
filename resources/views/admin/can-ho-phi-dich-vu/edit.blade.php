...
@section('title', 'Chỉnh sửa dịch vụ căn hộ')
@section('page-title', 'Chỉnh sửa dịch vụ căn hộ')
...
<div class="max-w-2xl" x-data="formCanHoPhiDV()">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            <h3 class="font-semibold text-gray-700">Chỉnh sửa dịch vụ căn hộ</h3>
            <span class="text-xs text-gray-400 font-mono">ID: {{ $canHoPhiDichVu->id }}</span>
        </div>

        <form action="{{ route('admin.can-ho-phi-dich-vu.update', $canHoPhiDichVu) }}" method="POST" class="p-6 space-y-5">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <select name="phi_dich_vu" x-model="phiDVId" @change="onPhiDVChange()"
                    ...
                    <option value="{{ $dv->id }}"
                            ...
                            {{ old('phi_dich_vu', $canHoPhiDichVu->phi_dich_vu) == $dv->id ? 'selected' : '' }}>
                        {{ $dv->ten_phi_dich_vu }}
            ...
            <div>
                ...
                <div class="relative">
                    <input type="number" name="don_gia" value="{{ old('don_gia', $canHoPhiDichVu->don_gia) }}" min="0" step="1000"
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('admin.can-ho-phi-dich-vu.show', $canHoPhiDichVu) }}"

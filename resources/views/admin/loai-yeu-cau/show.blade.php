    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-lg {{ $loaiYeuCau->deletedAt ? 'bg-gray-100' : 'bg-blue-100' }} flex items-center justify-center">
                    <svg class="w-5 h-5 {{ $loaiYeuCau->deletedAt ? 'text-gray-400' : 'text-blue-600' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="flex items-center gap-2">
                ...
                <a href="{{ route('admin.loai-yeu-cau.edit', $loaiYeuCau) }}"
                ...
                @else
                <form action="{{ route('admin.loai-yeu-cau.restore', $loaiYeuCau->id) }}" method="POST" class="inline">
                    @csrf @method('PATCH')
                ...
                @endif
                <a href="{{ route('admin.loai-yeu-cau.index') }}" class="flex items-center gap-1 px-3 py-1.5 border border-gray-200 text-gray-500 text-sm rounded-lg hover:bg-gray-50">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

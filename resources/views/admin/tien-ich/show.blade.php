...
<div class="max-w-4xl mx-auto space-y-5" x-data="{ open: false }">
    ...
    <div class="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-200 dark:border-indigo-800 p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.tien-ich.edit', $tienIch) }}"
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 dark:border-slate-700 flex items-center justify-between">
            ...
            <a href="{{ route('admin.dat-lich-tien-ich.index', ['tien_ich' => $tienIch->id]) }}" class="text-xs text-indigo-600 dark:text-indigo-400 hover:underline">Xem tất cả</a>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-slate-700">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                        <td class="px-4 py-3">
                            <a href="{{ route('admin.dat-lich-tien-ich.show', $dl) }}" class="font-mono font-medium text-indigo-600 dark:text-indigo-400 hover:underline">{{ $dl->ma_dat_lich }}</a>
                        </td>
    ...
    <div x-show="open"
        ...
        <div class="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl w-full max-w-sm mx-auto p-6" @click.stop>
            ...
            <div class="flex gap-3">
                ...
                <form action="{{ route('admin.tien-ich.destroy', $tienIch) }}" method="POST" class="flex-1">
                    @csrf @method('DELETE')

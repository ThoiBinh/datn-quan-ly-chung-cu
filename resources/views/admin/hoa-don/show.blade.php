        ...
        <div class="flex items-center gap-2 flex-wrap">
            ...
            <span title="Không thể sửa hóa đơn đã phát sinh thanh toán.">
                <button type="button" disabled
                        class="inline-flex items-center gap-2 px-3.5 py-2 border border-gray-200 dark:border-slate-700 rounded-lg text-sm font-medium text-gray-400 dark:text-slate-500 opacity-60 cursor-not-allowed">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm p-5">
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div>
                ...
                @if($daPhatSinhTT)
                <span class="ml-2 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400">

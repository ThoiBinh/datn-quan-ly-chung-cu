...
<div class="space-y-5 max-w-3xl">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('admin.thuoc-tinh.edit', $thuocTinh) }}"
                ...
                <a href="{{ route('admin.thuoc-tinh.index') }}" class="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1 px-3 py-1.5 border border-gray-200 rounded-lg">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {{-- Căn hộ sử dụng thuộc tính này --}}
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h3 class="text-sm font-semibold text-gray-700">
                Căn hộ đang sử dụng thuộc tính này
                <span class="ml-2 inline-flex items-center justify-center w-6 h-6 rounded-full text-xs font-bold bg-blue-100 text-blue-700">{{ $thuocTinh->canHo->count() }}</span>
            </h3>
        </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <a href="{{ route('admin.can-ho.show', $canHo) }}" class="font-medium text-blue-600 hover:underline">
                                {{ $canHo->so_can_ho }}
                            </a>
                        </td>

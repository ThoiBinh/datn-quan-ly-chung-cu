...
<div class="max-w-xl">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <a href="{{ route('admin.thuoc-tinh.index') }}" class="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1">
        ...
        <form action="{{ route('admin.thuoc-tinh.store') }}" method="POST" class="p-6 space-y-5">
            @csrf

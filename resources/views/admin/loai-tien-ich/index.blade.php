...
<div class="space-y-5" x-data="{ open: false, url: '', name: '' }" @open-delete.window="open = true; url = $event.detail.url; name = $event.detail.name">
    ...
    <div class="flex flex-col justify-between gap-4 rounded-2xl bg-white dark:bg-slate-800 p-5 shadow-sm lg:flex-row lg:items-center">
        ...
        <div class="flex items-center gap-2 self-start lg:self-auto">
            ...
            <a href="{{ route('admin.loai-tien-ich.create') }}"
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm p-4">
        <form method="GET" action="{{ route('admin.loai-tien-ich.index') }}" class="flex flex-wrap gap-2">
            ...
            <a href="{{ route('admin.loai-tien-ich.index') }}" class="px-4 py-2.5 border border-gray-300 dark:border-slate-600 text-gray-600 dark:text-slate-300 rounded-lg text-sm hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">Xóa lọc</a>
            @endif
        </form>
    </div>
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-slate-700/50">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                        ...
                        <td class="px-4 py-3.5">
                            <a href="{{ route('admin.loai-tien-ich.show', $loai) }}" class="font-medium text-gray-800 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400">
                        ...
                        <td class="px-4 py-3.5">
                            <div class="flex items-center gap-1 justify-end">
                                <a href="{{ route('admin.loai-tien-ich.show', $loai) }}" title="Xem chi tiết"
                                ...
                                <a href="{{ route('admin.loai-tien-ich.edit', $loai) }}" title="Chỉnh sửa"
                                ...
                                @if($loai->tien_ich_count === 0)
                                <button type="button"
                                        @click="$dispatch('open-delete', { url: '{{ route('admin.loai-tien-ich.destroy', $loai) }}', name: '{{ addslashes($loai->ten_loai_tien_ich) }}' })"

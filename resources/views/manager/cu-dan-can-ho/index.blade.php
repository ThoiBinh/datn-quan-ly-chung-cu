...
<div class="space-y-5">
    ...
    <div class="flex items-center justify-between flex-wrap gap-3">
        ...
        <a href="{{ route('manager.cu-dan-can-ho.create') }}"
    ...
    {{-- Filter --}}
    <form method="GET" action="{{ route('manager.cu-dan-can-ho.index') }}"
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        @php
                            $sortLink = fn($col) => route('manager.cu-dan-can-ho.index', array_merge(request()->except(['sort','direction','page']), [
                                'sort'      => $col,
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-3">
                                <a href="{{ route('manager.cu-dan-can-ho.show', $r) }}"
                                   class="text-indigo-600 hover:text-indigo-800 text-xs font-medium">Xem</a>
                                <a href="{{ route('manager.cu-dan-can-ho.edit', $r) }}"
                                   class="text-amber-600 hover:text-amber-800 text-xs font-medium">Sửa</a>
                                <form method="POST" action="{{ route('manager.cu-dan-can-ho.toggle-status', $r) }}"

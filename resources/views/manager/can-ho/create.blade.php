...
@section('content')
<div class="max-w-3xl">
    <form method="POST" action="{{ route('manager.can-ho.store') }}" class="space-y-5">
        @csrf
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
            <div class="px-5 py-4 border-b border-gray-200 dark:border-gray-700 flex items-center gap-2">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500">Tích chọn và nhập giá trị cho từng thuộc tính</p>
                </div>
            </div>

...
<div class="space-y-5" x-data="{ open: false, url: '', name: '' }" @open-delete.window="open = true; url = $event.detail.url; name = $event.detail.name">
        ...
        <div class="flex items-center gap-2 self-start lg:self-auto">
            <div class="relative" x-data="{ open: false }" @click.away="open = false">
                ...
                <div x-show="open" x-transition x-cloak
                    ...
                    <a href="{{ route('manager.loai-tien-ich.index') }}" class="flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-slate-300 hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">
                        <span>📂</span>
            ...
            <a href="{{ route('manager.tien-ich.create') }}"
    ...
    <div class="bg-white dark:bg-slate-800 rounded-xl border border-gray-200 dark:border-slate-700 shadow-sm p-4">
        <form method="GET" action="{{ route('manager.tien-ich.index') }}" class="flex flex-wrap gap-2">
            ...
            <a href="{{ route('manager.tien-ich.index') }}" class="px-4 py-2.5 border border-gray-300 dark:border-slate-600 text-gray-600 dark:text-slate-300 rounded-lg text-sm hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors">Xóa lọc</a>
            @endif
        </form>
    </div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-50 dark:divide-slate-700/50">
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-slate-700/30 transition-colors">
                        ...
                        <td class="px-4 py-3.5">
                            <a href="{{ route('manager.tien-ich.show', $ti) }}" class="font-medium text-gray-800 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400">
                                {{ $ti->ten_tien_ich }}
                            </a>
                            @if($ti->can_dat_truoc)
                        ...
                        <td class="px-4 py-3.5">
                            <div class="flex items-center gap-1 justify-end">
                                <a href="{{ route('manager.tien-ich.show', $ti) }}" title="Xem chi tiết"
                                ...
                                <a href="{{ route('manager.tien-ich.edit', $ti) }}" title="Chỉnh sửa"
                                ...
                                <button type="button"
                                        @click="$dispatch('open-delete', { url: '{{ route('manager.tien-ich.destroy', $ti) }}', name: '{{ addslashes($ti->ten_tien_ich) }}' })"

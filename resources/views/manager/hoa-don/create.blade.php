            ...
            <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[85vh] flex flex-col"
                ...
                <div class="flex items-center justify-between px-5 py-4 border-b border-gray-100 flex-shrink-0">
                    <div class="flex items-center gap-2.5">
                        ...
                        <div>
                            <h3 class="text-sm font-semibold text-gray-800">Thêm dịch vụ vào hóa đơn</h3>
                            <p class="text-xs text-gray-400">Chọn dịch vụ muốn thêm</p>
                        </div>
                    </div>
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-2">
                    ...
                    <template x-if="!modalLoading && modalServices.length === 0">
                        <div class="text-center py-10 text-sm text-gray-400">Căn hộ này chưa được gán dịch vụ nào.</div>
                    </template>
                    <template x-if="!modalLoading && modalServices.length > 0">
                        <div class="space-y-2">
                            <template x-for="svc in modalServices" :key="svc.phi_dich_vu_id">
                                <label :class="isInFees(svc.phi_dich_vu_id) ? 'opacity-50 cursor-not-allowed bg-gray-50' : 'cursor-pointer hover:bg-indigo-50 bg-white'"
                                       class="flex items-center gap-3 p-3 border border-gray-200 rounded-xl transition-colors">
                ...
                <div class="flex items-center justify-between gap-3 px-5 py-4 border-t border-gray-100 flex-shrink-0">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <button type="button" @click="addSelectedToFees()"
                                ...
                                :class="selectedInModal.length === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-indigo-700'"

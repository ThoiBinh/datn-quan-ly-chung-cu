    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('manager.don-vi-tinh-phi-dich-vu.edit', $donViTinhPhiDichVu) }}"
                ...
                <a href="{{ route('manager.don-vi-tinh-phi-dich-vu.index') }}" class="flex items-center gap-1 px-3 py-1.5 border border-gray-200 text-gray-500 text-sm rounded-lg hover:bg-gray-50">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-6 grid grid-cols-2 gap-4 text-sm">
            ...
            <div>
                ...
                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-sm font-semibold
                    {{ $phiDichVus->count() > 0 ? 'bg-indigo-100 text-indigo-700' : 'bg-gray-100 text-gray-500' }}">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-center">
                            <span class="inline-flex items-center justify-center w-8 h-8 rounded-full text-xs font-semibold
                                {{ $phi->canHo->count() > 0 ? 'bg-indigo-100 text-indigo-700' : 'bg-gray-100 text-gray-500' }}">
                                {{ $phi->canHo->count() }}
                            </span>
                        </td>
                    </tr>

        ...
        <form action="{{ route('manager.cau-hinh-thanh-toan.update', $cauHinhThanhToan) }}" method="POST" class="p-6 space-y-5">
            ...
            <div>
                ...
                <textarea name="gia_tri" rows="3"
                          ...
                          class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">{{ old('gia_tri', $cauHinhThanhToan->gia_tri) }}</textarea>
                @else

...
@section('title', 'Sửa loại yêu cầu')
@section('page-title', 'Sửa loại yêu cầu')

@section('content')
<div class="max-w-xl">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
            <h2 class="text-base font-semibold text-gray-800">Chỉnh sửa loại yêu cầu</h2>
            <a href="{{ route('manager.loai-yeu-cau.show', $loaiYeuCau) }}" class="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1">
        ...
        <form action="{{ route('manager.loai-yeu-cau.update', $loaiYeuCau) }}" method="POST" class="p-6 space-y-5">
            @csrf @method('PUT')
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name', $loaiYeuCau->name) }}"
            ...
            <div class="flex gap-3 pt-2">
                ...
                <a href="{{ route('manager.loai-yeu-cau.show', $loaiYeuCau) }}"

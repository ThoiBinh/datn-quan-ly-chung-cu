...
<div class="max-w-2xl mx-auto space-y-5">
    ...
    <nav class="flex items-center gap-1.5 text-sm text-gray-500">
        ...
        <a href="{{ route('manager.phi-dich-vu.show', $phiDichVu) }}" class="hover:text-indigo-600 transition-colors truncate max-w-xs">{{ $phiDichVu->ten_phi_dich_vu }}</a>
        <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
    ...
    <form id="update-form" action="{{ route('manager.phi-dich-vu.update', $phiDichVu) }}" method="POST" class="space-y-5">
        @csrf @method('PUT')
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            <div class="flex items-center gap-2.5 px-5 py-4 border-b border-gray-100">
                ...
                <h2 class="text-sm font-semibold text-gray-800">Chỉnh sửa thông tin</h2>
            </div>
            ...
            <div class="p-5 space-y-4">
                <div>
                    ...
                    <input type="text" name="ten_phi_dich_vu"
                           value="{{ old('ten_phi_dich_vu', $phiDichVu->ten_phi_dich_vu) }}" maxlength="150"
                ...
                <div>
                    ...
                    <input type="number" name="don_gia"
                           value="{{ old('don_gia', $phiDichVu->don_gia) }}" min="0" step="1000"
    ...
    <div class="flex items-center justify-between">
        <a href="{{ route('manager.phi-dich-vu.show', $phiDichVu) }}"

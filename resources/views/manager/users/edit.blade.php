        ...
        <form method="POST" action="{{ route('manager.users.update', $user) }}" class="p-5 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="role" class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        <option value="resident" {{ old('role', $user->role) == 'resident' ? 'selected' : '' }}>Cư dân</option>

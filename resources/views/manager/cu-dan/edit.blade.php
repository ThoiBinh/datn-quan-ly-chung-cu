        ...
        <form method="POST" action="{{ route('manager.cu-dan.update', $cuDan) }}" class="p-5 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div class="col-span-2">
                    ...
                    <input type="text" name="ho_ten" value="{{ old('ho_ten', $cuDan->ho_ten) }}" required
                ...
                <div>
                    ...
                    <input type="date" name="nam_sinh" value="{{ old('nam_sinh', $cuDan->nam_sinh?->format('Y-m-d')) }}"
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>
                <div class="col-span-2">
                    <label class="block text-sm font-medium text-gray-700 mb-1">Quê quán</label>
                    <input type="text" name="que_quan" value="{{ old('que_quan', $cuDan->que_quan) }}"
                           class="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                </div>
            </div>

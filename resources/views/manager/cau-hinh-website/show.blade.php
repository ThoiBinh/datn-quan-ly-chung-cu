...
<div class="max-w-3xl space-y-5" x-data="{ confirmToggle: false }">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div class="p-6 flex items-start gap-5">
            ...
            <div class="flex-1">
                ...
                <span class="inline-flex items-center gap-1.5 text-xs font-semibold text-red-500">
                    <span class="w-1.5 h-1.5 rounded-full bg-red-500"></span> Vô hiệu hóa
                </span>
                @endif
            </div>
        </div>
        ...
        <div class="px-6 py-4 border-t border-gray-100 flex flex-wrap gap-3">
            <a href="{{ route('manager.cau-hinh-website.edit', $cauHinhWebsite) }}"
            ...
            <a href="{{ route('manager.cau-hinh-website.index') }}"
    ...
    <div x-show="confirmToggle"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm mx-auto p-6" @click.stop>
            <div class="text-center mb-5">
                ...
                <p class="font-semibold text-gray-800">Vô hiệu hóa cấu hình?</p>
                <p class="text-sm text-gray-500 mt-1">Cấu hình này sẽ không được sử dụng.</p>
                @else
                ...
                <p class="font-semibold text-gray-800">Kích hoạt cấu hình?</p>
                <p class="text-sm text-gray-500 mt-1">Cấu hình này sẽ được sử dụng trong hệ thống.</p>
                @endif
            </div>
            <div class="flex gap-3">
                ...
                <form action="{{ route('manager.cau-hinh-website.toggle-status', $cauHinhWebsite) }}" method="POST" class="flex-1">
                    @csrf @method('PATCH')
                    @if($cauHinhWebsite->trang_thai)

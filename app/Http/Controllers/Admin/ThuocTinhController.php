...
class ThuocTinhController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.thuoc-tinh.index', compact(
    ...
    {
        return view('admin.thuoc-tinh.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.thuoc-tinh.show', $thuocTinh)
    ...
    public function show(ThuocTinh $thuocTinh)
    {
        ...
        return view('admin.thuoc-tinh.show', compact('thuocTinh'));
    }

    public function edit(ThuocTinh $thuocTinh)
    {
        return view('admin.thuoc-tinh.edit', compact('thuocTinh'));
    }
    ...
    public function destroy(ThuocTinh $thuocTinh)
    {
        ...
        return redirect()->route('admin.thuoc-tinh.index')

...
use App\Http\Requests\Admin\StoreTrangThaiCanHoRequest;
use App\Http\Requests\Admin\UpdateTrangThaiCanHoRequest;
...
class TrangThaiCanHoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.trang-thai-can-ho.index', compact(
    ...
    {
        return view('admin.trang-thai-can-ho.create');
    }
    ...
    public function store(StoreTrangThaiCanHoRequest $request)
    {
        ...
        return redirect()->route('admin.trang-thai-can-ho.show', $trangThai)
    ...
    public function show(TrangThaiCanHo $trangThaiCanHo)
    {
        ...
        return view('admin.trang-thai-can-ho.show', compact('trangThaiCanHo'));
    }

    public function edit(TrangThaiCanHo $trangThaiCanHo)
    {
        return view('admin.trang-thai-can-ho.edit', compact('trangThaiCanHo'));
    }
    ...
    public function update(UpdateTrangThaiCanHoRequest $request, TrangThaiCanHo $trangThaiCanHo)
    {
        ...
        return redirect()->route('admin.trang-thai-can-ho.show', $trangThaiCanHo)
    ...
    public function destroy(TrangThaiCanHo $trangThaiCanHo)
    {
        ...
        return redirect()->route('admin.trang-thai-can-ho.index')

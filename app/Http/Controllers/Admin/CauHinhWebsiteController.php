...
use App\Http\Requests\Admin\UpdateCauHinhWebsiteRequest;
...
class CauHinhWebsiteController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.cau-hinh-website.index', compact(
    ...
    {
        return view('admin.cau-hinh-website.show', compact('cauHinhWebsite'));
    }

    public function edit(CauHinhWebsite $cauHinhWebsite)
    {
        return view('admin.cau-hinh-website.edit', compact('cauHinhWebsite'));
    }

...
class ChucVuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.chuc-vu.index', compact(
    ...
    {
        return view('admin.chuc-vu.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.chuc-vu.show', $chucVu)
    ...
    public function show(ChucVu $chucVu)
    {
        ...
        return view('admin.chuc-vu.show', compact(
    ...
    {
        return view('admin.chuc-vu.edit', compact('chucVu'));
    }
    ...
    public function destroy(ChucVu $chucVu)
    {
        ...
        return redirect()->route('admin.chuc-vu.index')

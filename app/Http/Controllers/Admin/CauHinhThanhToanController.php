...
use App\Http\Requests\Admin\StoreCauHinhThanhToanRequest;
use App\Http\Requests\Admin\UpdateCauHinhThanhToanRequest;
...
class CauHinhThanhToanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $tongVoHieuHoa = CauHinhWebsite::payment()->where('trang_thai', 0)->count();

        return view('admin.cau-hinh-thanh-toan.index', compact(
            'nhomMomo', 'nhomVnpay', 'nhomQr', 'nhomKhac', 'tongHoatDong', 'tongVoHieuHoa'
        ));
    }

    public function create()
    {
        return view('admin.cau-hinh-thanh-toan.create');
    }
    ...
    public function store(StoreCauHinhThanhToanRequest $request)
    {
        ...
        return redirect()->route('admin.cau-hinh-thanh-toan.show', $cauHinh)
    ...
    public function edit(CauHinhWebsite $cauHinhThanhToan)
    {
        ...
        return view('admin.cau-hinh-thanh-toan.edit', compact('cauHinhThanhToan'));
    }

...
{
    private const SORTABLE = ['createdAt', 'loai_phuong_thuc', 'trang_thai', 'ten_nha_cung_cap'];
    ...
    public function index(Request $request)
    {
        ...
        if ($request->filled('search')) {
            ...
            $query->where(fn($q) => $q
                ...
                ->orWhere('dinh_danh_thu_huong', 'like', "%$s%")
        ...
        if ($request->filled('loai')) {
            $query->where('loai_phuong_thuc', $request->loai);
        }
        ...
        $tongVoHieuHoa = CauHinhThanhToan::where('trang_thai', 0)->count();

        return view('admin.cau-hinh-thanh-toan.index', compact(
            'dsCauHinh', 'dsLoai', 'sort', 'direction', 'tongHoatDong', 'tongVoHieuHoa'
        ));
    }
    ...
    {
        $dsLoai = CauHinhThanhToan::select('loai_phuong_thuc')->distinct()->pluck('loai_phuong_thuc');
        return view('admin.cau-hinh-thanh-toan.create', compact('dsLoai'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.cau-hinh-thanh-toan.show', $ch)
    ...
    public function show(CauHinhThanhToan $cauHinhThanhToan)
    {
        ...
        return view('admin.cau-hinh-thanh-toan.show', compact('cauHinhThanhToan'));
    }

    public function edit(CauHinhThanhToan $cauHinhThanhToan)
    {
        $dsLoai = CauHinhThanhToan::select('loai_phuong_thuc')->distinct()->pluck('loai_phuong_thuc');
        return view('admin.cau-hinh-thanh-toan.edit', compact('cauHinhThanhToan', 'dsLoai'));
    }
    ...
    public function update(Request $request, CauHinhThanhToan $cauHinhThanhToan)
    {
        ...
        return redirect()->route('admin.cau-hinh-thanh-toan.show', $cauHinhThanhToan)

...
class DonViTinhPhiDichVuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.don-vi-tinh-phi-dich-vu.index', compact(
    ...
    {
        return view('admin.don-vi-tinh-phi-dich-vu.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.don-vi-tinh-phi-dich-vu.show', $item)
    ...
    public function show(DonViTinhPhiDichVu $donViTinhPhiDichVu)
    {
        ...
        return view('admin.don-vi-tinh-phi-dich-vu.show', compact('donViTinhPhiDichVu'));
    }

    public function edit(DonViTinhPhiDichVu $donViTinhPhiDichVu)
    {
        return view('admin.don-vi-tinh-phi-dich-vu.edit', compact('donViTinhPhiDichVu'));
    }
    ...
    public function update(Request $request, DonViTinhPhiDichVu $donViTinhPhiDichVu)
    {
        ...
        return redirect()->route('admin.don-vi-tinh-phi-dich-vu.show', $donViTinhPhiDichVu)
    ...
    public function destroy(DonViTinhPhiDichVu $donViTinhPhiDichVu)
    {
        ...
        return redirect()->route('admin.don-vi-tinh-phi-dich-vu.index')

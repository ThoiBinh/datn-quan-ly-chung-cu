...
class LoaiPhiDichVuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.loai-phi-dich-vu.index', compact(
    ...
    {
        return view('admin.loai-phi-dich-vu.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.loai-phi-dich-vu.show', $loai)
    ...
    public function show(LoaiPhiDichVu $loaiPhiDichVu)
    {
        ...
        return view('admin.loai-phi-dich-vu.show', compact('loaiPhiDichVu'));
    }

    public function edit(LoaiPhiDichVu $loaiPhiDichVu)
    {
        return view('admin.loai-phi-dich-vu.edit', compact('loaiPhiDichVu'));
    }
    ...
    public function update(Request $request, LoaiPhiDichVu $loaiPhiDichVu)
    {
        ...
        return redirect()->route('admin.loai-phi-dich-vu.show', $loaiPhiDichVu)
    ...
    public function destroy(LoaiPhiDichVu $loaiPhiDichVu)
    {
        ...
        return redirect()->route('admin.loai-phi-dich-vu.index')

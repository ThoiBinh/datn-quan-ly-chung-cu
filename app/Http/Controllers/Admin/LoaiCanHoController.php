...
class LoaiCanHoController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.loai-can-ho.index', compact(
    ...
    {
        return view('admin.loai-can-ho.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.loai-can-ho.show', $loai)
    ...
    public function show(LoaiCanHo $loaiCanHo)
    {
        ...
        return view('admin.loai-can-ho.show', compact('loaiCanHo'));
    }

    public function edit(LoaiCanHo $loaiCanHo)
    {
        return view('admin.loai-can-ho.edit', compact('loaiCanHo'));
    }
    ...
    public function update(Request $request, LoaiCanHo $loaiCanHo)
    {
        ...
        return redirect()->route('admin.loai-can-ho.show', $loaiCanHo)
    ...
    public function destroy(LoaiCanHo $loaiCanHo)
    {
        ...
        return redirect()->route('admin.loai-can-ho.index')

...
use App\Http\Requests\Manager\StoreLoaiTienIchRequest;
use App\Http\Requests\Manager\UpdateLoaiTienIchRequest;
...
class LoaiTienIchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.loai-tien-ich.index', compact(
    ...
    {
        return view('manager.loai-tien-ich.create');
    }
    ...
    public function store(StoreLoaiTienIchRequest $request)
    {
        ...
        return redirect()->route('manager.loai-tien-ich.show', $loaiTienIch)
    ...
    public function show(LoaiTienIch $loaiTienIch)
    {
        ...
        return view('manager.loai-tien-ich.show', compact('loaiTienIch'));
    }

    public function edit(LoaiTienIch $loaiTienIch)
    {
        return view('manager.loai-tien-ich.edit', compact('loaiTienIch'));
    }
    ...
    public function destroy(LoaiTienIch $loaiTienIch)
    {
        ...
        return redirect()->route('manager.loai-tien-ich.index')

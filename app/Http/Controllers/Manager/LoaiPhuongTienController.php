...
class LoaiPhuongTienController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.loai-phuong-tien.index', compact(
    ...
    {
        return view('manager.loai-phuong-tien.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.loai-phuong-tien.show', $loai)
    ...
    public function show(LoaiPhuongTien $loaiPhuongTien)
    {
        ...
        return view('manager.loai-phuong-tien.show', compact('loaiPhuongTien'));
    }

    public function edit(LoaiPhuongTien $loaiPhuongTien)
    {
        return view('manager.loai-phuong-tien.edit', compact('loaiPhuongTien'));
    }
    ...
    public function update(Request $request, LoaiPhuongTien $loaiPhuongTien)
    {
        ...
        return redirect()->route('manager.loai-phuong-tien.show', $loaiPhuongTien)
    ...
    public function destroy(LoaiPhuongTien $loaiPhuongTien)
    {
        ...
        return redirect()->route('manager.loai-phuong-tien.index')

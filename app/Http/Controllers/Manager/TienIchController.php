...
use App\Http\Requests\Manager\StoreTienIchRequest;
use App\Http\Requests\Manager\UpdateTienIchRequest;
...
class TienIchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.tien-ich.index', array_merge(
    ...
    {
        return view('manager.tien-ich.create', $this->danhSachLua());
    }
    ...
    public function store(StoreTienIchRequest $request)
    {
        ...
        return redirect()->route('manager.tien-ich.show', $tienIch)
    ...
    public function show(TienIch $tienIch)
    {
        ...
        return view('manager.tien-ich.show', [
            'tienIch'     => $tienIch,
    ...
    {
        return view('manager.tien-ich.edit', array_merge(
            ['tienIch' => $tienIch],
            $this->danhSachLua()
        ));
    }
    ...
    public function destroy(TienIch $tienIch)
    {
        ...
        return redirect()->route('manager.tien-ich.index')

...
use App\Http\Requests\Manager\CancelDatLichTienIchRequest;
use App\Http\Requests\Manager\RejectDatLichTienIchRequest;
use App\Http\Requests\Manager\StoreDatLichTienIchRequest;
use App\Http\Requests\Manager\UpdateDatLichTienIchRequest;
...
class DatLichTienIchController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.dat-lich-tien-ich.index', compact(
    ...
    public function dashboard()
    {
        ...
        return view('manager.dat-lich-tien-ich.dashboard', compact(
    ...
    {
        return view('manager.dat-lich-tien-ich.create', $this->danhSachLua());
    }
    ...
    public function store(StoreDatLichTienIchRequest $request)
    {
        ...
        return redirect()->route('manager.dat-lich-tien-ich.show', $datLich)
    ...
    public function show(DatLichTienIch $datLichTienIch)
    {
        ...
        return view('manager.dat-lich-tien-ich.show', compact('datLichTienIch'));
    }

    public function edit(DatLichTienIch $datLichTienIch)
    {
        return view('manager.dat-lich-tien-ich.edit', array_merge(
    ...
    public function destroy(DatLichTienIch $datLichTienIch)
    {
        ...
        return redirect()->route('manager.dat-lich-tien-ich.index')

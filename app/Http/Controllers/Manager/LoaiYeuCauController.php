...
class LoaiYeuCauController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.loai-yeu-cau.index', compact(
    ...
    {
        return view('manager.loai-yeu-cau.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.loai-yeu-cau.show', $loai)
    ...
    public function show(LoaiYeuCau $loaiYeuCau)
    {
        ...
        return view('manager.loai-yeu-cau.show', compact('loaiYeuCau'));
    }

    public function edit(LoaiYeuCau $loaiYeuCau)
    {
        return view('manager.loai-yeu-cau.edit', compact('loaiYeuCau'));
    }
    ...
    public function update(Request $request, LoaiYeuCau $loaiYeuCau)
    {
        ...
        return redirect()->route('manager.loai-yeu-cau.show', $loaiYeuCau)
    ...
    public function destroy(LoaiYeuCau $loaiYeuCau)
    {
        ...
        return redirect()->route('manager.loai-yeu-cau.index')
    ...
    public function restore(int $id)
    {
        ...
        return redirect()->route('manager.loai-yeu-cau.show', $loaiYeuCau->id)

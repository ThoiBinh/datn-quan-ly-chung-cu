...
class VaiTroController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.vai-tro.index', compact('dsVaiTro', 'sort', 'direction', 'tongTatCa', 'tongDangDung'));
    }

    public function create()
    {
        return view('manager.vai-tro.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.vai-tro.show', $vaiTro)
    ...
    public function show(VaiTro $vaiTro)
    {
        ...
        return view('manager.vai-tro.show', compact('vaiTro'));
    }

    public function edit(VaiTro $vaiTro)
    {
        return view('manager.vai-tro.edit', compact('vaiTro'));
    }
    ...
    public function destroy(VaiTro $vaiTro)
    {
        ...
        return redirect()->route('manager.vai-tro.index')

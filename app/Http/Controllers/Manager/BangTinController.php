...
class BangTinController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('manager.bang-tin.index', compact('dsBangTin', 'sort', 'direction'));
    }

    public function create()
    {
        return view('manager.bang-tin.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('manager.bang-tin.show', $bt)
    ...
    public function show(BangTin $bangTin)
    {
        ...
        return view('manager.bang-tin.show', compact('bangTin'));
    }

    public function edit(BangTin $bangTin)
    {
        return view('manager.bang-tin.edit', compact('bangTin'));
    }
    ...
    public function update(Request $request, BangTin $bangTin)
    {
        ...
        return redirect()->route('manager.bang-tin.show', $bangTin)

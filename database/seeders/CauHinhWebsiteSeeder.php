...
class CauHinhWebsiteSeeder extends Seeder
{
    ...
    {
        $rows = [
            ['ma_thuoc_tinh' => 'ten_chung_cu',           'ten_thuoc_tinh' => 'Tên chung cư',              'gia_tri' => 'Chung cư Urbano',                                              'kieu_du_lieu' => 'text',     'ma_nhom' => 'general', 'ten_nhom' => 'Thông tin chung', 'mo_ta' => null, 'placeholder' => null, 'thu_tu' => 1,  'la_bao_mat' => false],
